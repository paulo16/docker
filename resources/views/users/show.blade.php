...
<div class="page-header">
	<h1>
		...
		<small>
			...
			quelques informations sur le user 
		</small>
	</h1>
</div><!-- /.page-header -->
				...
				<div class="col-xs-12 col-sm-3 center">
					<div>
						<span class="profile-picture">
							@if ($user->photo)
							<img id="avatar" class="editable img-responsive editable-click editable-empty" src="{{Storage::url($user->photo)}}" alt="Avatar">
							@else
						...
						<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
							<div class="inline position-relative">
								<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
									...
									&nbsp;
									<span class="white">{{ $user->name}} &nbsp;&nbsp; {{$user->lastname }}</span>
								</a>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span class="editable editable-click" id="username">{{$user->name}}&nbsp;&nbsp;{{$user->lastname}} </span>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span class="editable editable-click" id="signup">{{$user->telephone}}</span>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span class="editable editable-click" id="login">{{$user->email}}</span>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span class="editable editable-click" id="about">{{$user->created_at}}</span>
							</div>
						</div>
					</div>
